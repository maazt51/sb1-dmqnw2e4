            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-800">
                  <strong>Online Booking Site Temporarily Down for Maintenance</strong> - please call us at{' '}
                  <a href="tel:206-223-1501" className="font-semibold underline hover:text-red-900">
                    206-223-1501
                  </a>
                </p>
              </div>
